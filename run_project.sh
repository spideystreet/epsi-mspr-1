...
jupyter nbconvert --to notebook --execute notebooks/data_preprocessing.ipynb --output notebooks/data_preprocessing.executed.ipynb

echo "Running model training notebook..."
jupyter nbconvert --to notebook --execute notebooks/model_training.ipynb --output notebooks/model_training.executed.ipynb

echo "Running prediction notebook..."
jupyter nbconvert --to notebook --execute notebooks/prediction.ipynb --output notebooks/prediction.executed.ipynb
